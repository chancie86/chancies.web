...
export default function CookieConsent() {
  ...
  return respondedToConsent || <Grid className={classes.container}>
    <Grid container>
      <Grid item xs={1} md={2} lg={3} />
        <Grid item xs={10} md={8} lg={6} container className={classes.content}>
          <Grid container className={classes.header}>
            ...
            <Button style={{ marginRight: '1em' }} onClick={() => updateConstent(true)}>Allow</Button>
          </Grid>
          <IconButton
          ...
          <Grid className={classes.message}>
            <span>
              This site uses Google Analytics which helps to analyze web traffic. This helps to understand how the website is being used to improve content.
              Click 'Allow' to grant permission to collect tracking information about how you use the website.
            </span>
          </Grid>
